...
namespace TestLib
{
    ...
    public class CheckCloudForm : WinForms.Form
    {
        ...
        private WinForms.CheckBox chkUseSelectionWindow;
        ...
        private void InitializeComponent()
        {
            ...
            chkUseSelectionWindow = new WinForms.CheckBox();
            chkUseSelectionWindow.Text = "範囲選択したブロックのみ対象";
            chkUseSelectionWindow.Left = 20;
            chkUseSelectionWindow.Top = 110;
            chkUseSelectionWindow.Width = 360;
            chkUseSelectionWindow.Checked = false;

            chkVisibleLayerOnly = new WinForms.CheckBox();
            chkVisibleLayerOnly.Text = "表示中の画層のみ対象";
            chkVisibleLayerOnly.Left = 20;
            chkVisibleLayerOnly.Top = 140;
            ...
            chkDeleteExistingClouds.Top = 170;
            ...
            this.Controls.Add(chkUseSelectionWindow);
        ...
        private void BtnCreate_Click(object sender, EventArgs e)
        {
            ...
            bool useSelectionWindow = chkUseSelectionWindow.Checked;
            ...
            try
            {
                ...
                if (useSelectionWindow && (blockAlignedGroup || blockEach))
                {
                    // 範囲指定時はフォームを一時的に隠す
                    this.Hide();
        ...
        private static List<ObjectId> PromptBlockSelectionByWindow(Editor ed)
        {
             ...
             * 指定範囲に少しでもかかったブロック参照も対象にする。
             *
             * 完全に範囲内に入ったブロックだけ対象にしたい場合は、
             * SelectWindow に変更する。
             */
